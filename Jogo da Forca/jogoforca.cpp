...
string retornaPalavraAleatoria(){
    ...
    string palavras[3] = {"laranja", "manga", "morango"};
...
int jogar(int numeroDeJogadores){
    ...
    while(palavra != palavraComMascara && maximoDeTentativas - tentativas > 0){
        ...
        //Lê um palpite
        cout << "\nDigite uma letra (Ou digite 1 para arriscar numa palavra):";
        cin >> letra;
 
        //Se digitar 1 deixa o jogador arriscar a palavra inteira
        if(letra == '1'){
        ...
        if(jaDigitouLetra == false){
            ...
            if(acertouLetra == false){
                ...
                mensagem = "Errou numa letra!";
 
            }else{
 
                mensagem = "Acertou numa letra!";
    ...
    while(opcao < 1 || opcao > 3){
        ...
        switch(opcao){
            ...
            case 3:
                ...
                limpaTela();
                cout << "Jogo desenvolvido por Filipa em 2022";
                cout << "\n1 - Voltar";
                cout << "\n2 - Sair";
                cin >> opcao;
                if(opcao == 1){
